...
def move_back(inertia_interval=5.0):
    print "Wally will move back..."
    clockwise(True)
    clockwise(False)
    ...
    time.sleep(inertia_interval=5.0)
...
def move_forward(inertia_interval=5.0):
    print "Wally will move forward..."
    counter_clockwise(True)
    counter_clockwise(False)
